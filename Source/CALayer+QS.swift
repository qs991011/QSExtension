...
extension CALayer {
    ...
    func addFadeAnimation(duration:TimeInterval,curve:UIView.AnimationCurve) {
        if duration <= 0 {return}
        var mediaFunction : String!
        switch curve {
        case .easeInOut:
            mediaFunction = CAMediaTimingFunctionName.easeOut.rawValue
            break
        case .easeIn:
            mediaFunction = CAMediaTimingFunctionName.easeIn.rawValue
            break
        case .easeOut:
            mediaFunction = CAMediaTimingFunctionName.linear.rawValue
            break
        default:
            mediaFunction = CAMediaTimingFunctionName.linear.rawValue
            break
        ...
        transition.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName(rawValue: mediaFunction!))
